...
> **Beta release (v2.1.4 Beta) — things are subject to change.** 
...
> [!WARNING]
> For versions 2.1.3 and under macos may show "App is damaged" while trying to run it to fix it either do **sudo xattr -rc '/Applications/TruckersMP for macOS.app' '** or **codesign --force --deep --sign - "/Applications/TruckersMP for macOS.app"**
---
